...
`ss<tab><issue_id><tab><score>` | sets a score for a certain issue inside the database. <br/> <br/> **issue_id** - a string of numbers. Found within the issue_id field in either the ouput or database of the issue. <br/> **score** - a number chosen by the user to represent its relevance.
