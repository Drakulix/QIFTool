...
sn<tab><issue_id><tab><message> | (set notes) - sets a note for a certain issue inside the database <br/> issue_id - a string of numbers. Found within the issue_id field in either the ouput or database of the issue. <br/> message - a string of characters that will be inserted into the notes field inside the database.
